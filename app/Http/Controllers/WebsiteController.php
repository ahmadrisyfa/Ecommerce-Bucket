...
class WebsiteController extends Controller
{
    public function index() 
    {
        ...
        ->take(3)
        ->get();
        $category =  DB::table('category')->take(3)->latest()->get();
        $slider = Slider::all();
        return view('website.index',compact('slider','product','category'));
    }
    ...
    public function productdetail($id)
    {
        ...
        $size = Size::all();
        $customLembar = CustomLembar::all();
        $data = Product::find($id);
        return view('website.product-detail',compact('data','productRandom','size','customLembar'));
    }
    ...
    public function CheckoutData(Request $request)
    {
        ...
        foreach ($dataCart as $cart) {
            ...
            Transaksi::create([
                ...
                'custom_lembar_id' => $cart['custom_lembar_id'],
