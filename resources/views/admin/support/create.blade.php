...
<div class="row">
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Form Tambah Data Support <small>Silahkan Tambahkan Data</small></h2>              
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <br />
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{url('admin/support/create')}}" enctype="multipart/form-data" method="Post">
                    @csrf
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <textarea type="text"  name="deskripsi" required="required" class="form-control" style="height: 500px"></textarea>
                        </div>
                    </div>                                 
